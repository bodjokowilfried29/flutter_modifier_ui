...
class _SliverSemanticsElement<S extends SliverScope>
  ...
  @override
  bool byWidgetType(Type type) => type == SliverSemantics;
...
class _SliverSemanticsFromPropertiesElement<S extends SliverScope>
  ...
  const _SliverSemanticsFromPropertiesElement({
    this.key,
    this.container = false,
    this.explicitChildNodes = false,
    this.excludeSemantics = false,
  ...
  @override
  Widget build(Widget child) {
    return SliverSemantics.fromProperties(
      key: key,
      container: container,
      explicitChildNodes: explicitChildNodes,
      excludeSemantics: excludeSemantics,
...
extension SliverSemanticsFromPropertiesModifier<S extends SliverScope>
  ...
  Modifier<S> sliverSemanticsFromProperties({
    ...
    return then(
      _SliverSemanticsFromPropertiesElement<S>(
        key: key,
        container: container,
        explicitChildNodes: explicitChildNodes,
        excludeSemantics: excludeSemantics,
